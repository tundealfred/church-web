...
export interface ApiCellCell extends Schema.CollectionType {
  ...
  attributes: {
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::cell.cell', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    ...
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<'api::cell.cell', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiMemberMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Date: Attribute.Date;
    Email: Attribute.Email;
    Involvement: Attribute.Relation<
      'api::member.member',
      'oneToMany',
      'api::cell.cell'
    >;
    ...
    prayer_request: Attribute.Relation<
      'api::member.member',
      'manyToOne',
...
export interface ApiPrayerRequestPrayerRequest extends Schema.CollectionType {
  ...
  attributes: {
    Condition: Attribute.Enumeration<['New', 'In Progress', 'Answered']>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::prayer-request.prayer-request',
      'oneToOne',
    ...
    publishedAt: Attribute.DateTime;
    Request: Attribute.Blocks;
    Submitted: Attribute.Relation<
      'api::prayer-request.prayer-request',
      'oneToMany',
      'api::member.member'
    >;
